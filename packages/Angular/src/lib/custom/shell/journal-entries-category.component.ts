 ...
 * category's pages: Dashboard · All journal entries · JE workspace | Awaiting approval (badge).
 * (Scheduled entries removed with the retired ScheduledJournalEntry system, D15.)
 */
@Component({
  standalone: false,
...
export class JournalEntriesCategoryComponent extends CategoryShellBase {
  ...
  public get RailSections(): MJLeftNavSection[] {
    return [
      {
        // ONE flat, unlabeled group (Marcelo 2026-07-29): section labels were filler ('MAIN'/'VIEWS'

...
export const mjBizAppsAccountingGLAccountRoleSchema = z.object({
    ...
    *   * Inactive
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    Cardinality: z.union([z.literal('Many'), z.literal('One')]).describe(`
        * * Field Name: Cardinality
        * * Display Name: Cardinality
        * * SQL Data Type: nvarchar(10)
        * * Default Value: One
    * * Value List Type: List
    * * Possible Values 
...
export class mjBizAppsAccountingAccountingCompanyProfileEntity extends BaseEntity<mjBizAppsAccountingAccountingCompanyProfileEntityType> {
    ...
    * * Table-Level: A company cannot be set as its own parent company. This prevents circular parent-child relationships in the accounting company hierarchy.
    * @public
    * @method
    * @override
    */
    ...
    */
    ...
    /**
    * A company cannot be set as its own parent company. This prevents circular parent-child relationships in the accounting company hierarchy.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class mjBizAppsAccountingGLAccountRoleEntity extends BaseEntity<mjBizAppsAccountingGLAccountRoleEntityType> {
    ...
    * * Description: How many Active GLAccountLinks this role may resolve to for one record and company. One (default, every pre-existing role including Cash): the BA-D32 tie guard applies and ResolveLinkedAccount returns a single account, latest StartedAt winning among overlapping links. Many: the tie guard does not apply and ResolveLinkedAccount REFUSES the role rather than returning an arbitrary account — callers use ResolveLinkedAccounts and get every Active link whose window covers AsOf. Separating the two is what lets a company hold N bank accounts for a cash position without disturbing where payments post.
    */
    get Cardinality(): 'Many' | 'One' {
        return this.Get('Cardinality');
    }
    set Cardinality(value: 'Many' | 'One') {
        this.Set('Cardinality', value);
    }
}
...
export class mjBizAppsAccountingJournalEntryBatchSequenceEntity extends BaseEntity<mjBizAppsAccountingJournalEntryBatchSequenceEntityType> {
    ...
    * * ID: The ID of this record must be exactly 1. This ensures that only a single configuration or sequence record exists in the system.
    ...
    */
    ...
    /**
    * The ID of this record must be exactly 1. This ensures that only a single configuration or sequence record exists in the system.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */

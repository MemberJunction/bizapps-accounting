...
//****************************************************************************
@ObjectType({ description: `A payment made against a TaxLiability. Generates a JE via PostedJournalEntryID (typed with the \'TaxRemittance\' JournalEntryType — see issue #24 on which app seeds that type).` })

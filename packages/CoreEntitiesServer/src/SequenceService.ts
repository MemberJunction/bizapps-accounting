...
/**
 * Atomically increments the PER-COMPANY per-FY JE counter and returns the
 * formatted EntryNumber 'JE-{CompanyCode}-{FY}-{seq:000000}' (MOD-12 +
 * master numbering — supersedes the D-SEQ global shape). The sproc resolves
 * CompanyCode from the AccountingCompanyProfile and throws 50024 when the
 * company has no profile.
 */

...
| `QUESTIONS.md` | **Structured question stock** (questions convention, adopted 2026-07-16): the repo's COMMITTED question stock (entries migrated here from the instance stock 2026-07-16 — planning state survives instance deletion): priority + feature indexes + Q22/Q24-template entries; new questions append with the next free Qn. |
| `TRANSFER-BACKLOG.md` | Components PARKED in this app for iteration speed but owed to other homes (bizapps-tasks, common, MJ base) — target + trigger per row; reviewed at each team-question consolidation. |

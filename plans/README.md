...
| `QUESTIONS.md` | **Structured question stock** (questions convention, adopted 2026-07-16): derived priority + feature indexes linking this repo's open questions (currently homed in the instance stock); new repo-scoped questions append here in the Q22/Q24 entry template. |

...
- **Change (the locked structure):**
  1. **Category model — RULED (Marcelo 2026-07-21, orders Q24): PER-COMPANY CATEGORY ROWS**
     (`ProductCategory.CompanyID` NOT NULL) with identical-name **display-collapse in the UI** —

...
// Import supplemental manifests — common first so Currency / Organization
// classes register before any Accounting class references them.
import {CLASS_REGISTRATIONS as COMMON_CLASSES} from '@mj-biz-apps/common-ng';
import {CLASS_REGISTRATIONS as LOCAL_CLASSES} from '@mj-biz-apps/accounting-ng';

// static code path builder
const combinedClasses = [...CLASS_REGISTRATIONS, ...COMMON_CLASSES, ...LOCAL_CLASSES];

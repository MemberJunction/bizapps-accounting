-- BizAppsAccounting: Add Predictive Anomaly Outcome Columns & Engineered View Features
-- Materialized columns for Predictive Studio journal entry anomaly forecasting and operational sorting/filtering.
...
---------------------------------------------------------------------------
ALTER TABLE ${flyway:defaultSchema}.[JournalEntry] ADD
...
ALTER TABLE ${flyway:defaultSchema}.[JournalEntry] ADD CONSTRAINT [CK_JournalEntry_PredictedAnomalyRiskBand]
...
---------------------------------------------------------------------------
-- 2. Update vwJournalEntries: include engineered training features
---------------------------------------------------------------------------
CREATE OR ALTER VIEW [${flyway:defaultSchema}].[vwJournalEntries]
AS
SELECT
    j.*,
...
/* SQL text to insert 11 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '65a6d82b-e0f2-441c-b528-d02fd788cba5' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'PredictedAnomalyProbability')) BEGIN
         ...
         (
            ...
            'C040A1FC-16CE-49CB-B0E2-4F233BD0D762', -- Entity: MJ_BizApps_Accounting: Journal Entries
            (SELECT COALESCE(MAX([Sequence]), 0) + 1 FROM [${mjSchema}].[EntityField] WHERE [EntityID] = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762'),
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '13845d9d-67e5-427c-956f-ec0fb19b5859' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'PredictedAnomalyRiskBand')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '85fb2f62-1428-43df-8053-90e3014500a0' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'PredictedAnomalyScoredAt')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '71836c90-010c-4f03-a0f2-abe0e37eda3d' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'AnomalyOutcome')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'b55285d4-5dd5-42e4-8395-013e87ee0ecb' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'TotalDebitAmount')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '2bee0bbb-bc51-4fcf-9a48-45d9e25e8734' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'LineCount')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '0be539d7-f9ae-4ca6-b18b-9fe77f456617' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'EffectiveMonth')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'e404e4ba-43e1-4d79-ae84-0a7c00f19f3c' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'EffectiveDayOfWeek')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'dda19850-854f-4d3b-ac92-1341b56e1990' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'IsWeekend')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '059438ff-3c74-4ab3-82ac-b08de48ef205' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'HasLinkedRecord')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '3388c921-27ff-42dd-b308-65e4577df0fe' OR (EntityID = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND Name = 'HasFile')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
EXEC [${mjSchema}].[spDeleteUnneededEntityFields] @ExcludedSchemaNames='', @EntityIDs='C040A1FC-16CE-49CB-B0E2-4F233BD0D762', @IncludedSchemaNames='${flyway:defaultSchema}';

/* SQL text to update existing entity fields from schema (1 scoped entities) */
EXEC [${mjSchema}].[spUpdateExistingEntityFieldsFromSchema] @ExcludedSchemaNames='', @EntityIDs='C040A1FC-16CE-49CB-B0E2-4F233BD0D762', @IncludedSchemaNames='${flyway:defaultSchema}';
...
/* Update FieldCategoryInfo setting for entity */
  ...
  "Anomaly Detection": {
    ...
    "icon": "fa fa-exclamation-triangle"
                  ...
                  WHERE [EntityID] = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND [Name] = 'FieldCategoryInfo';
...
/* Update FieldCategoryIcons setting (legacy) */
  ...
  "Anomaly Detection": "fa fa-exclamation-triangle"
                  ...
                  WHERE [EntityID] = 'C040A1FC-16CE-49CB-B0E2-4F233BD0D762' AND [Name] = 'FieldCategoryIcons';

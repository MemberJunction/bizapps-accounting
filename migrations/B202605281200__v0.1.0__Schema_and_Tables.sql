...
-- spSeedDefaultRecurringJournalEntryTemplates, and spInitializeAccountingCompanyProfile
-- here. They've been moved to TypeScript BaseEntity subclasses in
-- packages/CoreEntitiesServer/ so that:
...
--      or recurring templates per Company.
--
